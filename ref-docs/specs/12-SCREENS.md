...
> **관련 문서**: [01-SPEC](01-SPEC.md) · [10-DESIGN_SYSTEM](10-DESIGN_SYSTEM.md) · [11-COMPONENTS](11-COMPONENTS.md) · [13-HAPTICS_AND_MOTION](13-HAPTICS_AND_MOTION.md) · [14-ACCESSIBILITY](14-ACCESSIBILITY.md) · [31-VIEWER_HTML](31-VIEWER_HTML.md) · [전체 인덱스](README.md)
...
| 작성일 | 2026-05-12 |
| 버전 기반 | v4 |
| 원본 출처 | [01-SPEC.md](01-SPEC.md) §7 (566-624), §10.2 (704-762) |
...
본 문서는 Stitch 시안 22화면을 specs/ 시리즈와 연결하는 화면 카탈로그다. 각 Stitch 화면에 대해 담당 기능 명세(01-SPEC.md §N), 컴포넌트(11-COMPONENTS §N), 플로우(02-USER_FLOWS F-?), 햅틱/모션(13-HAPTICS_AND_MOTION §N)의 매핑 좌표를 확정한다.
...
| ID | 화면 명 | Stitch 경로 | 분류 | 01-SPEC.md 매핑 | specs/ 매핑 |
|----|--------|------------|------|---------------|-------------|
| iphone-2.1 | 홈 (라운드 리스트) | screens/iphone/round_on_home_screen/ | iPhone | §7.1 항목 1 (01-SPEC.md:568) | 02-USER_FLOWS F-A 진입 |
| iphone-2.2 | 새 라운드 시작 | screens/iphone/new_round_setup/ | iPhone | §7.1 항목 2 (01-SPEC.md:569) | 02-USER_FLOWS F-A → F-B |
| iphone-2.3a | 라운드 진행 Variant A | screens/iphone/round_in_progress_variant_a/ | iPhone | §7.1 항목 3 (01-SPEC.md:570) | 11-COMPONENTS §6 ScoreCell.horizontalScroll |
| iphone-2.3b | 라운드 진행 Variant B ★ | screens/iphone/round_in_progress_variant_b/ | iPhone | §7.1 항목 3 (01-SPEC.md:570) | 11-COMPONENTS §6 ScoreCell.split9x2 — **D-1 채택** |
| iphone-2.4 | 페널티 입력 모달 | screens/iphone/penalty_input_modal/ | iPhone | 01-SPEC.md:83-85 | 11-COMPONENTS §7 PenaltyButton |
| iphone-2.5 | 사진 첨부 | screens/iphone/photo_attach_screen/ | iPhone | §7.1 항목 4 (01-SPEC.md:571) | 11-COMPONENTS §8 PhotoGalleryGrid |
| iphone-2.6 | 라운드 종료 요약 | screens/iphone/round_end_summary/ | iPhone | §7.1 항목 5 (01-SPEC.md:572) | 02-USER_FLOWS F-D |
| iphone-2.7 | 공유 옵션 모달 | screens/iphone/share_options_modal/ | iPhone | §7.1 항목 6 (01-SPEC.md:573-581) | 02-USER_FLOWS F-E, 11-COMPONENTS §9 ShareSheet |
| iphone-2.8 | 라운드 상세 (사후 보기) | screens/iphone/round_detail_completed/ | iPhone | §7.1 항목 7 (01-SPEC.md:582) | 02-USER_FLOWS F-E 업데이트 분기 |
| iphone-2.9 | 설정 | screens/iphone/settings_screen/ | iPhone | §7.1 항목 8 (01-SPEC.md:583) | 10-DESIGN_SYSTEM §2 팔레트 선택 |
| watch-3.1 | 메인 점수 입력 (Winter) | screens/watch/apple_watch_score_input_winter/ | Watch | §7.2 (01-SPEC.md:587-606) | 02-USER_FLOWS F-C |
| watch-3.2 | 홀 전환 시작 프레임 | screens/watch/hole_change_start_h7_fading/ | Watch | 01-SPEC.md:97 | 13-HAPTICS_AND_MOTION §5 |
| watch-3.3 | 홀 전환 중간 프레임 | screens/watch/hole_change_mid_h8_sliding/ | Watch | 01-SPEC.md:97 | 13-HAPTICS_AND_MOTION §5 |
| watch-3.4 | 홀 전환 종료 프레임 | screens/watch/hole_change_end_h8_active/ | Watch | 01-SPEC.md:97 | 13-HAPTICS_AND_MOTION §5 |
| watch-3.5 | 동반자 전환 오버레이 | screens/watch/apple_watch_player_switch_overlay/ | Watch | 01-SPEC.md:98 | 02-USER_FLOWS F-C, 11-COMPONENTS §6 PlayerChip |
| watch-3.6 | 라운드 종료 메뉴 | screens/watch/apple_watch_round_end_menu/ | Watch | 01-SPEC.md:109 | 02-USER_FLOWS F-D |
| watch-3.7 | 라운드 종료 확인 | screens/watch/apple_watch_round_end_confirmation/ | Watch | 01-SPEC.md:109 | 02-USER_FLOWS F-D |
| web-4.1 | 모바일 웹 뷰어 메인 | screens/mobile-web/round_on_mobile_web_viewer/ | Mobile-Web | 01-SPEC.md:147-151 | 02-USER_FLOWS F-F, 31-VIEWER_HTML §2 |
| web-4.2 | PIN 잠금 화면 | screens/mobile-web/round_on_web_viewer_pin_lock/ | Mobile-Web | 01-SPEC.md:148 | 02-USER_FLOWS F-F PIN 분기, 33-SECURITY §5 |
| web-4.3 | 사진 라이트박스 | screens/mobile-web/round_on_web_lightbox/ | Mobile-Web | 01-SPEC.md:205-213 | 02-USER_FLOWS F-G, 31-VIEWER_HTML §7 |
| web-4.4 | 사진 저장 플로우 문서화 | screens/mobile-web/round_on_photo_save_flow_documentation/ | Mobile-Web | 01-SPEC.md:205-213 | 31-VIEWER_HTML §6 동작 매트릭스 |
| web-4.5 | 만료/오류 페이지 | screens/mobile-web/round_on_web_viewer_error_states/ | Mobile-Web | 01-SPEC.md:148 | 30-API_SPEC §7 에러 코드 |
...
- **요약**: 최근 라운드 카드 리스트 + "새 라운드 시작" FAB. (01-SPEC.md:568)
...
- **요약**: GPS 자동 매칭 결과 표시 + 동반자 별명 입력 최대 3명. (01-SPEC.md:569)
...
- **요약**: 4인 × 18홀 가로 스크롤 스코어카드. 한 화면에 4-5홀 표시. (01-SPEC.md:570)
...
- **요약**: OUT(1-9홀) / IN(10-18홀) 2단 분리 스코어카드. 세로 화면 한 번에 전체 표시. (01-SPEC.md:570, 01-SPEC.md:206)
...
- **요약**: OB +2 / 해저드 +1 / OK +1 인라인 모달. (01-SPEC.md:83-85)
...
- **요약**: 라운드 중/후 사진 첨부. 최대 30장, 1장 최대 10MB. (01-SPEC.md:134-138)
...
- **요약**: 총 스코어, 홀별 par 대비, 사진 미리보기, 공유 진입. (01-SPEC.md:572)
...
- **요약**: 이름 공개(실명/익명), 접근 권한(공개/PIN 4자리), 사진 첨부 여부, 7일 만료 안내, "공유 링크 생성" CTA. (01-SPEC.md:573-581)
...
- **요약**: 완료된 라운드의 전체 스코어카드 + 사진 관리 + viewer 재공유. (01-SPEC.md:582)
...
- **요약**: iCloud 동기화, HealthKit 권한, 4계절 테마 선택, OSM ODbL 표기. (01-SPEC.md:583)
...
- **요약**: 홀 번호, par, 카운터(0에서 시작), par 대비 수치, 하단 OB/해저드/OK 버튼 행. (01-SPEC.md:587-606)
...
- **요약**: 상/하 스와이프 시 본인 ↔ 동반자 전환. 동반자 별명 오버레이 표시. (01-SPEC.md:98)
...
- **요약**: "라운드 종료" 선택 메뉴. 종료 / 취소 2가지 옵션. (01-SPEC.md:109)
- **컴포넌트**: (Watch 시스템 메뉴)
...
- **요약**: 최종 종료 확인 다이얼로그. 홀별 요약 요약 정보 1줄 표시. (01-SPEC.md:109)
- **컴포넌트**: (Watch 시스템 얼럿)
...
- **요약**: full-bleed 대표 사진 hero + 총 타수 대형 표시 + 스코어 표 + 사진 그리드 + ZIP 다운로드 버튼. (01-SPEC.md:147-151)
...
- **요약**: 자물쇠 아이콘 + PIN 4자리 입력 박스 4개 독립 배치 + "확인" 버튼. (01-SPEC.md:148)
...
- **요약**: 사진 전체 화면 + 인덱스 표시 + 좌/우 이동 + 닫기. (01-SPEC.md:205-213)
...
- **요약**: OS별(iOS/Android/데스크톱) 사진 저장 동작 매트릭스 시각화. 구현 사양서 성격의 화면. (01-SPEC.md:205-213)
...
- **요약**: 410 만료 / 404 없음 / 429 PIN 잠금 3개 오류 상태 프레임. (01-SPEC.md:148)
...
| 미제공 화면 | 플로우 | 처리 방침 |
|-----------|--------|---------|
| 위치 권한 요청 다이얼로그 | F-A | iOS 시스템 표준 얼럿 — 커스텀 UI 없음 (01-SPEC.md:657-659) |
| 강제 종료 후 자동 재개 다이얼로그 | F-D | `.alert(isPresented:)` 시스템 기본 사용 (01-SPEC.md:107-108) |
| HealthKit 권한 요청 | F-B | iOS 시스템 표준 권한 시트 (01-SPEC.md:116-119) |
| Watch 미연결 안내 배너 | F-B | `BannerNotice` 컴포넌트 재사용 (11-COMPONENTS §10) |
| 수동 골프장 검색/선택 | F-A 분기 | 검색 시트 — 별도 설계 필요 (01-SPEC.md:634-635) |
