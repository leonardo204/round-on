...
- 앱 실행 시 GPS로 한국 골프장 자동 매칭 (반경 3km, 한국 골프장 DB v3 1,163곳) (spec_3.md:58-61)
...
| 한국 골프장 + 서브코스 자동 감지 | 앱 실행 시 GPS로 한국 골프장 DB v3 (1,163곳)와 즉시 매칭. F3 GPS 자동 감지 — 골프장 + 서브코스 단위 (홀 단위 자동 감지는 미제공, 수동 진행). 수동 변경 가능 | spec_3.md:57-62 |
...
한국 골프장 DB v3 (1,163곳, 2026-05-12 빌드) 기준: 1,163곳 중 1,139곳 `dataQuality: low` (클럽하우스 좌표만 보유). complete 3곳 (전체의 0.26%) / partial 12곳 / minimal 9곳 / low 1139곳.

**F3 GPS 자동 감지 — 골프장 + 서브코스 단위 (홀 단위 자동 감지는 미제공, 수동 진행)**: 골프장 단위 감지는 모든 1,163곳에서 동작. 홀 단위 자동 감지는 미제공 — 수동 홀 진행 모드가 디폴트. dataQuality 기반 분기 처리 필수. (CLAUDE.md §PROJECT)
