...
> **타겟 플랫폼**: iOS 18+ / watchOS 10+  
> **Viewer 도메인**: `golf.zerolive.co.kr`
> **개발 방식**: 단일 Phase, 한 번에 전체 개발 (Claude Code)  
> **작성일**: 2026-05-11  
> **버전**: v4 (모바일 viewer 강화 + 작업 분담 + 사전 문서 리스트)
>
> **2026-05-18 변경**: **사진 기능 전면 폐기** (앱 내 첨부 + viewer 갤러리 + R2 저장 모두). 사유: 개인정보보호 + 서버 비용 절감. 공유 viewer는 스코어카드 + 만료 시각만 표시. 본 명세서의 F9/F10/사진 관련 모든 섹션은 무효이며 별도 patch 없이 폐기됨으로 간주.
>
...
> **"한 번 탭할 때마다 한 타. 라운드 끝나면 친구들에게 스코어 공유."**
>
> (구 컨셉의 "사진과 함께"는 2026-05-18 폐기됨)
